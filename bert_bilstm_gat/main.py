...
def parse_arguments():
    ...
    parser.add_argument("--train_partition", dest="train_partition", type=str, default='0')
    parser.add_argument("--tune_from", dest="tune_from", type=str, default='')
    parser.add_argument("--test", dest="test", type=str, default='data/balancedtest.csv')
    ...
    parser.add_argument("--ntags", dest="ntags", type=int, default=4)
